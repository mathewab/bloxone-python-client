...
class TestInfraServicesCreateOrUpdateDfpService404ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InfraServicesCreateOrUpdateDfpService404ResponseError:
