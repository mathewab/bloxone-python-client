...
class TestInfraServicesCreateOrUpdateDfpService400ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InfraServicesCreateOrUpdateDfpService400ResponseError:
