...
class InfraServicesApi:
    ...
    def CreateOrUpdateDfpService(
        self,
        payload_service_id: Annotated[StrictStr, Field(description="The DNS Forwarding Proxy Service ID object identifier.")],
        body: Annotated[DfpCreateOrUpdatePayload, Field(description="The DNS Forwarding Proxy object.")],
    ...
    def _CreateOrUpdateDfpService_serialize(
        ...
        if payload_service_id is not None:
            _path_params['payload.service_id'] = self.api_client.path_param_value('payload.service_id', payload_service_id, value_type='resource_id')
    ...
    def ListDfpServices(
        ...
        _param = self._ListDfpServices_serialize(
            filter=filter,
            fields=fields,
            offset=offset,
            limit=limit,
    ...
    def ReadDfpService(
        self,
        service_id: Annotated[StrictStr, Field(description="The On-Prem Application Service identifier. For internal Use only")],
        id: Annotated[Optional[StrictInt], Field(description="The DNS Forwarding Proxy object identifier.")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="  A collection of response resources can be transformed by specifying a set of JSON tags to be returned. For a “flat” resource, the tag name is straightforward. If field selection is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, the tag does not appear in the output resource.  Specify this parameter as a comma-separated list of JSON tag names.        ")] = None,
        name: Annotated[Optional[StrictStr], Field(description="The name of the DNS Forwarding Proxy. Used only if the 'id' field is empty.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ReadDfpService_serialize(
    ...
    def _ReadDfpService_serialize(
        ...
        if service_id is not None:
            _path_params['service_id'] = self.api_client.path_param_value('service_id', service_id, value_type='resource_id')
        # process the query parameters
        if id is not None:
