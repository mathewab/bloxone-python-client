...
class Resolver(BaseModel):
    ...
    Resolver
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="address that can be used as resolver")
    is_fallback: Optional[StrictBool] = Field(default=None, description="Mark it true to set default DNS resolvers that will be used in case if the BloxOne Cloud is unreachable.")
    is_local: Optional[StrictBool] = Field(default=None, description="Mark it true to set internal or local DNS servers' IPv4 or IPv6 addresses that are used as DNS resolvers")
    protocols: Optional[List[DNSProtocol]] = Field(default=None, description="The list of DNS resolver communication protocols.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "is_fallback", "is_local", "protocols"]
