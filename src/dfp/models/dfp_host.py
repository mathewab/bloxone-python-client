...
class DfpHost(BaseModel):
    ...
    DfpHost
    """ # noqa: E501
    legacy_host_id: Optional[StrictInt] = Field(default=None, description="// The DNS Forwarding Proxy legacy ID object identifier.")
    ...
    __properties: ClassVar[List[str]] = ["legacy_host_id", "name", "ophid", "site_id"]
