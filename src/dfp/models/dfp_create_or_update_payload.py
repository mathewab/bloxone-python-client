...
class DfpCreateOrUpdatePayload(BaseModel):
    ...
    """ # noqa: E501
    forwarding_policy: Optional[StrictStr] = Field(default=None, description="The type of DNS resolver as Forwarding Policy. It can hold values as ib_cloud_first, external_first or external_only The default value is ib_cloud_first. If empty string is sent then ib_cloud_first will be considered.")
    ...
    internal_domain_lists: Optional[List[StrictInt]] = Field(default=None, description="The list of internal domain list ids associated with this DFP (or resolvers)")
    ...
    resolvers_all: Optional[List[Resolver]] = Field(default=None, description="The DNS forwarding proxy additional resolvers used for fallback and local resolution. This field replaces resolvers and default_resolvers fields which are deprecated. Either deprecated fields or new field can be used, both can not be used at same time.")
    service_id: Optional[StrictStr] = Field(default=None, description="The DNS Forwarding Proxy Service ID object identifier.")
    service_name: Optional[StrictStr] = Field(default=None, description="The name of the DNS Forwarding Proxy Service.")
    ...
    __properties: ClassVar[List[str]] = ["forwarding_policy", "host", "id", "internal_domain_lists", "name", "pop_region_id", "resolvers_all", "service_id", "service_name", "site_id"]
