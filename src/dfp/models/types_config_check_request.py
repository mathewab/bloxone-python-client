...
class TypesConfigCheckRequest(BaseModel):
    ...
    notify: Optional[StrictBool] = Field(default=None, description="Caller sets to false if wants to suppress notification.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["account_id", "config_check_type", "notify"]
