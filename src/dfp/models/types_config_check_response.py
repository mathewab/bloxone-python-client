...
class TypesConfigCheckResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[TypesConfigCheckResult]] = Field(default=None, description="The list of check result.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [TypesConfigCheckResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
