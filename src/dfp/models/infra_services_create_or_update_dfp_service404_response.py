...
class InfraServicesCreateOrUpdateDfpService404Response(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[InfraServicesCreateOrUpdateDfpService404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": InfraServicesCreateOrUpdateDfpService404ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
