...
class DfpListResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[Dfp]] = Field(default=None, description="The list of DNS Forwarding Proxy objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Dfp.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
