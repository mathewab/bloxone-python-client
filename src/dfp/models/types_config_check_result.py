...
class TypesConfigCheckResult(BaseModel):
    ...
    """ # noqa: E501
    additional_info: Optional[StrictStr] = Field(default=None, description="Provides more info about the potential problem.")
    config_check_type: Optional[StrictStr] = Field(default=None, description="Service check type.")
    resource_uri: Optional[StrictStr] = Field(default=None, description="URI of the resource that was checked.")
    result_code: Optional[StrictStr] = Field(default=None, description="The check result.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["additional_info", "config_check_type", "resource_uri", "result_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config_check_type": obj.get("config_check_type"),
