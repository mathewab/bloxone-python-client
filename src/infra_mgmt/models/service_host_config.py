...
class ServiceHostConfig(BaseModel):
    ...
    """ # noqa: E501
    current_version: Optional[StrictStr] = Field(default=None, description="The current version of the Service deployed on the Host.")
    extra_data: Optional[StrictStr] = Field(default=None, description="The field to carry any extra data specific to this configuration.")
    host_id: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    id: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    service_id: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    service_type: Optional[StrictStr] = Field(default=None, description="The type of the Service deployed on the Host (`dns`, `cdc`, etc.).")
    upgraded_at: Optional[datetime] = Field(default=None, description="The timestamp of the latest upgrade of the Host-specific Service configuration.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["current_version", "extra_data", "host_id", "id", "service_id", "service_type", "upgraded_at"]
