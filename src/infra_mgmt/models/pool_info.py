...
class PoolInfo(BaseModel):
    ...
    PoolInfo
    """ # noqa: E501
    composite_status: Optional[StrictStr] = Field(default=None, description="Composite Status of the Pool that this resource belongs to (`online`, `degraded`, `error`, `unavailable`).")
    pool_id: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    pool_name: Optional[StrictStr] = Field(default=None, description="Name of the Pool that this resource belongs to.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["composite_status", "pool_id", "pool_name"]
