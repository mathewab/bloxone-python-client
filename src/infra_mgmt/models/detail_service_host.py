...
class DetailServiceHost(BaseModel):
    ...
    DetailServiceHost
    """ # noqa: E501
    composite_status: Optional[StrictStr] = Field(default=None, description="Composite Status of the Host (`online`, `degraded`, `error`, `offline`, `pending`, `awaiting approval`).")
    config: Optional[DetailServiceHostConfig] = None
    display_name: Optional[StrictStr] = Field(default=None, description="The name of the Host (unique).")
    ...
    __properties: ClassVar[List[str]] = ["composite_status", "config", "display_name", "id", "ip_address", "legacy_id", "maintenance_mode", "ophid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": DetailServiceHostConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
