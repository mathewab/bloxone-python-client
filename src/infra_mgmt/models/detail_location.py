...
class DetailLocation(BaseModel):
    ...
    DetailLocation
    """ # noqa: E501
    address: Optional[Dict[str, Any]] = Field(default=None, description="The address of the Location containing address, postal_code, city, state, and country.")
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="The metadata of the Location which could contain other info such as attributions.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "id", "latitude", "longitude", "metadata"]
