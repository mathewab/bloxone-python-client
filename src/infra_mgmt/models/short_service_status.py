...
class ShortServiceStatus(BaseModel):
    ...
    ShortServiceStatus
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Status message text for the Service.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the Service (`started`, `starting`, `stopping`, `stopped`, `error`).")
    updated_at: Optional[datetime] = Field(default=None, description="Timestamp of the latest status update of Service.")
