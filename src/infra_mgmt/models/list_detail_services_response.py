...
class ListDetailServicesResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": ApiPageInfo.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "results": [DetailService.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
