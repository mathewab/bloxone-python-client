...
class Service(BaseModel):
    ...
    """ # noqa: E501
    configs: Optional[List[ServiceHostConfig]] = Field(default=None, description="List of Host-specific configurations of this Service.")
    created_at: Optional[datetime] = Field(default=None, description="Timestamp of creation of Service.")
    description: Optional[StrictStr] = Field(default=None, description="The description of the Service (optional).")
    desired_state: Optional[StrictStr] = Field(default=None, description="The desired state of the Service. Should either be `\"start\"` or `\"stop\"`.")
    ...
    interface_labels: Optional[List[StrictStr]] = Field(default=None, description="List of interfaces on which this Service can operate. Note: The list can contain custom interface labels (Example: `[\"WAN\",\"LAN\",\"label1\",\"label2\"]`)")
    ...
    service_type: StrictStr = Field(description="The type of the Service deployed on the Host (`dns`, `cdc`, etc.).")
    ...
    __properties: ClassVar[List[str]] = ["configs", "created_at", "description", "desired_state", "desired_version", "id", "interface_labels", "name", "pool_id", "service_type", "tags", "updated_at"]
