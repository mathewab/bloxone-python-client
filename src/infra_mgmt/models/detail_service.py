...
class DetailService(BaseModel):
    ...
    DetailService
    """ # noqa: E501
    composite_state: Optional[StrictStr] = Field(default=None, description="Composite State of this Service (`started`, `stopped`, `stopping`, `starting`, `error`).")
    composite_status: Optional[StrictStr] = Field(default=None, description="Composite Status of this Service (`online`, `stopped`, `degraded`, `error`).")
    created_at: Optional[datetime] = Field(default=None, description="Timestamp of creation of Service.")
    current_version: Optional[StrictStr] = Field(default=None, description="Current version of this Service.")
    description: Optional[StrictStr] = Field(default=None, description="The description of the Service.")
    desired_state: Optional[StrictStr] = Field(default=None, description="The desired state of the Service (`\"start\"` or `\"stop\"`).")
    desired_version: Optional[StrictStr] = Field(default=None, description="The desired version of the Service.")
    hosts: Optional[List[DetailServiceHost]] = Field(default=None, description="List of Hosts on which this Service is deployed.")
    id: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    interface_labels: Optional[List[StrictStr]] = Field(default=None, description="List of interfaces on which this Service can operate.")
    ...
    service_type: Optional[StrictStr] = Field(default=None, description="The type of the Service deployed on the Host (`dns`, `cdc`, etc.).")
    tags: Optional[Dict[str, Any]] = Field(default=None, description="Tags associated with this Service.")
    updated_at: Optional[datetime] = Field(default=None, description="Timestamp of the latest update on Service.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["composite_state", "composite_status", "created_at", "current_version", "description", "desired_state", "desired_version", "hosts", "id", "interface_labels", "location", "name", "pool", "service_type", "tags", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "composite_state": obj.get("composite_state"),
            ...
            "desired_version": obj.get("desired_version"),
            "hosts": [DetailServiceHost.from_dict(_item) for _item in obj["hosts"]] if obj.get("hosts") is not None else None,
            "id": obj.get("id"),
            "interface_labels": obj.get("interface_labels"),
