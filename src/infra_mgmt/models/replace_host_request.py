...
class ReplaceHostRequest(BaseModel):
    ...
    ReplaceHostRequest
    """ # noqa: E501
    var_from: Optional[StrictStr] = Field(default=None, description="The resource identifier.", alias="from")
    to: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
