...
class DetailHostServiceConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["current_version", "service_id", "service_name", "service_type", "status", "upgraded_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": ShortServiceStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
