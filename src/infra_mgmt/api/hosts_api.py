...
class HostsApi:
    ...
    def AssignTags(
        ...
        _param = self._AssignTags_serialize(
            body=body,
    ...
    def Replace(
        self,
        from_resource_id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
        to_resource_id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
    ...
    def _Replace_serialize(
        ...
        if from_resource_id is not None:
            _path_params['from.resource_id'] = self.api_client.path_param_value('from.resource_id', from_resource_id)
        if to_resource_id is not None:
            _path_params['to.resource_id'] = self.api_client.path_param_value('to.resource_id', to_resource_id)
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    def UnassignTags(
        ...
        _param = self._UnassignTags_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
