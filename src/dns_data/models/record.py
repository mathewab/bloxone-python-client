...
class Record(BaseModel):
    ...
    """ # noqa: E501
    absolute_name_spec: Optional[StrictStr] = Field(default=None, description="Synthetic field, used to determine _zone_ and/or _name_in_zone_ field for records.")
    absolute_zone_name: Optional[StrictStr] = Field(default=None, description="The absolute domain name of the zone where this record belongs.")
    comment: Optional[StrictStr] = Field(default=None, description="The description for the DNS resource record. May contain 0 to 1024 characters. Can include UTF-8.")
    created_at: Optional[datetime] = Field(default=None, description="The timestamp when the object has been created.")
    delegation: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    disabled: Optional[StrictBool] = Field(default=None, description="Indicates if the DNS resource record is disabled. A disabled object is effectively non-existent when generating configuration.  Defaults to _false_.")
    dns_absolute_name_spec: Optional[StrictStr] = Field(default=None, description="The DNS protocol textual representation of _absolute_name_spec_.")
    dns_absolute_zone_name: Optional[StrictStr] = Field(default=None, description="The DNS protocol textual representation of the absolute domain name of the zone where this record belongs.")
    dns_name_in_zone: Optional[StrictStr] = Field(default=None, description="The DNS protocol textual representation of the relative owner name for the DNS zone.")
    dns_rdata: Optional[StrictStr] = Field(default=None, description="The DNS protocol textual representation of the DNS resource record data.")
    ...
    view_name: Optional[StrictStr] = Field(default=None, description="The display name of the DNS view that contains the parent zone of the DNS resource record.")
    zone: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["absolute_name_spec", "absolute_zone_name", "comment", "created_at", "delegation", "disabled", "dns_absolute_name_spec", "dns_absolute_zone_name", "dns_name_in_zone", "dns_rdata", "id", "inheritance_sources", "ipam_host", "name_in_zone", "options", "provider_metadata", "rdata", "source", "subtype", "tags", "ttl", "type", "updated_at", "view", "view_name", "zone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "absolute_name_spec": obj.get("absolute_name_spec"),
            "absolute_zone_name": obj.get("absolute_zone_name"),
            "comment": obj.get("comment"),
            "created_at": obj.get("created_at"),
            "delegation": obj.get("delegation"),
            "disabled": obj.get("disabled"),
            "dns_absolute_name_spec": obj.get("dns_absolute_name_spec"),
            "dns_absolute_zone_name": obj.get("dns_absolute_zone_name"),
            "dns_name_in_zone": obj.get("dns_name_in_zone"),
            "dns_rdata": obj.get("dns_rdata"),
            "id": obj.get("id"),
            "inheritance_sources": RecordInheritance.from_dict(obj["inheritance_sources"]) if obj.get("inheritance_sources") is not None else None,
            "ipam_host": obj.get("ipam_host"),
            "name_in_zone": obj.get("name_in_zone"),
