...
class SOASerialIncrementRequest(BaseModel):
    ...
    serial_increment: Optional[StrictInt] = Field(default=None, description="Default increment SOA serial number by 1,000.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "serial_increment": obj.get("serial_increment")
        })
