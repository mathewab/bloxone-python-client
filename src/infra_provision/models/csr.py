...
class CSR(BaseModel):
    ...
    csr: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = None
    ...
    __properties: ClassVar[List[str]] = ["activation_code", "client_ip", "created_at", "csr", "host_serial", "id", "join_token", "ophid", "signature", "src_ip", "state", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client_ip": TypesInetValue.from_dict(obj["client_ip"]) if obj.get("client_ip") is not None else None,
            "created_at": obj.get("created_at"),
            "csr": obj.get("csr"),
            "host_serial": obj.get("host_serial"),
            "id": obj.get("id"),
            "join_token": JoinToken.from_dict(obj["join_token"]) if obj.get("join_token") is not None else None,
            "ophid": obj.get("ophid"),
            "signature": obj.get("signature"),
            "src_ip": TypesInetValue.from_dict(obj["src_ip"]) if obj.get("src_ip") is not None else None,
            "state": obj.get("state"),
