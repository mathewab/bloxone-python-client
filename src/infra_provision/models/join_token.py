...
class JoinToken(BaseModel):
    ...
    token_id: Optional[StrictStr] = Field(default=None, description="first half of the token.")
    use_counter: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["deleted_at", "description", "expires_at", "id", "last_used_at", "name", "status", "tags", "token_id", "use_counter"]
