...
class ApiPageInfo(BaseModel):
    ...
    """ # noqa: E501
    offset: Optional[StrictInt] = Field(default=None, description="The service may optionally include the offset of the next page of resources. A null value indicates no more pages.")
    page_token: Optional[StrictStr] = Field(default=None, description="The service response should contain a string to indicate the next page of resources. A null value indicates no more pages.")
    size: Optional[StrictInt] = Field(default=None, description="The service may optionally include the total number of resources being paged.")
