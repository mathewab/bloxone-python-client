...
class UICSRApi:
    ...
    def Approve(
        self,
        activation_code: Annotated[StrictStr, Field(description="activation code is used by the clients to track the approval of the CSR")],
    ...
    def _Approve_serialize(
        ...
        if activation_code is not None:
            _path_params['activation_code'] = self.api_client.path_param_value('activation_code', activation_code)
    ...
    def Revoke(
        self,
        cert_serial: Annotated[StrictStr, Field(description="x509 serial number of the certificate. This can be obtained by parsing the client certificate file on the onprem. Either cert_serial or ophid is required")],
    ...
    def _Revoke_serialize(
        ...
        if cert_serial is not None:
            _path_params['cert_serial'] = self.api_client.path_param_value('cert_serial', cert_serial)
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    def Revoke2(
        self,
        ophid: Annotated[StrictStr, Field(description="On-prem host ID which can be obtained either from on-prem or BloxOne UI portal(Manage > Infrastructure > Hosts > Select the onprem > click on 3 dots on top right side > General Information > Ophid) .")],
        body: RevokeCertRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._Revoke2_serialize(
            ophid=ophid,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _Revoke2_serialize(
        ...
        if ophid is not None:
            _path_params['ophid'] = self.api_client.path_param_value('ophid', ophid)
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
