...
class AddressBlockApi:
    ...
    def Copy(
        self,
        id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
    ...
    def Create(
        self,
        body: AddressBlock,
        inherit: Annotated[Optional[StrictStr], Field(description="This parameter is used for getting inheritance_sources.  Allowed values: * _none_, * _partial_, * _full_.  Defaults to _none")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def CreateNextAvailableAB(
        self,
        id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
        cidr: Annotated[StrictInt, Field(description="The cidr value of address blocks to be created.")],
        count: Annotated[Optional[StrictInt], Field(description="Number of address blocks to generate. Default 1 if not set.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Name of next available address blocks.")] = None,
        comment: Annotated[Optional[StrictStr], Field(description="Comment of next available address blocks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def CreateNextAvailableIP(
        self,
        id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
        contiguous: Annotated[Optional[StrictBool], Field(description="Indicates whether the IP addresses should belong to a contiguous block.  Defaults to _false_.")] = None,
        count: Annotated[Optional[StrictInt], Field(description="The number of IP addresses requested.  Defaults to 1.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def CreateNextAvailableSubnet(
        self,
        id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
        cidr: Annotated[StrictInt, Field(description="The cidr value of subnets to be created.")],
        count: Annotated[Optional[StrictInt], Field(description="Number of subnets to generate. Default 1 if not set.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Name of next available subnets.")] = None,
        comment: Annotated[Optional[StrictStr], Field(description="Comment of next available subnets.")] = None,
        dhcp_host: Annotated[Optional[StrictStr], Field(description="Reference of OnPrem Host associated with the next available subnets to be created.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def List(
        self,
        fields: Annotated[Optional[StrictStr], Field(description="  A collection of response resources can be transformed by specifying a set of JSON tags to be returned. For a “flat” resource, the tag name is straightforward. If field selection is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, the tag does not appear in the output resource.  Specify this parameter as a comma-separated list of JSON tag names.        ")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="  A collection of response resources can be filtered by a logical expression string that includes JSON tag references to values in each resource, literal values, and logical operators. If a resource does not have the specified tag, its value is assumed to be null.  Literal values include numbers (integer and floating-point), and quoted (both single- or double-quoted) literal strings, and 'null'. The following operators are commonly used in filter expressions:  |  Op   |  Description               |  |  --   |  -----------               |  |  ==   |  Equal                     |  |  !=   |  Not Equal                 |  |  >    |  Greater Than              |  |   >=  |  Greater Than or Equal To  |  |  <    |  Less Than                 |  |  <=   |  Less Than or Equal To     |  |  and  |  Logical AND               |  |  ~    |  Matches Regex             |  |  !~   |  Does Not Match Regex      |  |  or   |  Logical OR                |  |  not  |  Logical NOT               |  |  ()   |  Groupping Operators       |        ")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="  The integer index (zero-origin) of the offset into a collection of resources. If omitted or null the value is assumed to be '0'.         ")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="  The integer number of resources to be returned in the response. The service may impose maximum value. If omitted the service may impose a default value.         ")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="  The service-defined string used to identify a page of resources. A null value indicates the first page.         ")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="  A collection of response resources can be sorted by their JSON tags. For a 'flat' resource, the tag name is straightforward. If sorting is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, its value is assumed to be null.)  Specify this parameter as a comma-separated list of JSON tag names. The sort direction can be specified by a suffix separated by whitespace before the tag name. The suffix 'asc' sorts the data in ascending order. The suffix 'desc' sorts the data in descending order. If no suffix is specified the data is sorted in ascending order.        ")] = None,
        torder_by: Annotated[Optional[StrictStr], Field(description="This parameter is used for sorting by tags.")] = None,
        tfilter: Annotated[Optional[StrictStr], Field(description="This parameter is used for filtering by tags.")] = None,
        inherit: Annotated[Optional[StrictStr], Field(description="This parameter is used for getting inheritance_sources.  Allowed values: * _none_, * _partial_, * _full_.  Defaults to _none")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def ListNextAvailableAB(
        self,
        id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
        cidr: Annotated[Optional[StrictInt], Field(description="The cidr value of address blocks to be created.")] = None,
        count: Annotated[Optional[StrictInt], Field(description="Number of address blocks to generate. Default 1 if not set.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Name of next available address blocks.")] = None,
        comment: Annotated[Optional[StrictStr], Field(description="Comment of next available address blocks.")] = None,
        _request_timeout: Union[
    ...
    def ListNextAvailableSubnet(
        self,
        id: Annotated[StrictStr, Field(description="An application specific resource identity of a resource")],
        cidr: Annotated[Optional[StrictInt], Field(description="The cidr value of subnets to be created.")] = None,
        count: Annotated[Optional[StrictInt], Field(description="Number of subnets to generate. Default 1 if not set.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Name of next available subnets.")] = None,
        comment: Annotated[Optional[StrictStr], Field(description="Comment of next available subnets.")] = None,
        dhcp_host: Annotated[Optional[StrictStr], Field(description="Reference of OnPrem Host associated with the next available subnets to be created.")] = None,
