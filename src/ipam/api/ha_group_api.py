...
class HaGroupApi:
    ...
    def List(
        ...
        collect_stats: Annotated[Optional[StrictBool], Field(description="collect_stats gets the HA group stats(state, status, heartbeat) if set to _true_ in the _GET_ _/dhcp/ha_group_ request.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
