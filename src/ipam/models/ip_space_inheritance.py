...
class IPSpaceInheritance(BaseModel):
    ...
    vendor_specific_option_option_space: Optional[InheritanceInheritedIdentifier] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asm_config", "ddns_client_update", "ddns_conflict_resolution_mode", "ddns_enabled", "ddns_hostname_block", "ddns_ttl_percent", "ddns_update_block", "ddns_update_on_renew", "ddns_use_conflict_resolution", "dhcp_config", "dhcp_options", "dhcp_options_v6", "header_option_filename", "header_option_server_address", "header_option_server_name", "hostname_rewrite_block", "vendor_specific_option_option_space"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.ddns_conflict_resolution_mode:
            _dict['ddns_conflict_resolution_mode'] = self.ddns_conflict_resolution_mode.to_dict()
        ...
        if self.ddns_use_conflict_resolution:
            _dict['ddns_use_conflict_resolution'] = self.ddns_use_conflict_resolution.to_dict()
        ...
        if self.header_option_filename:
            _dict['header_option_filename'] = self.header_option_filename.to_dict()
        ...
        if self.header_option_server_address:
            _dict['header_option_server_address'] = self.header_option_server_address.to_dict()
        ...
        if self.header_option_server_name:
            _dict['header_option_server_name'] = self.header_option_server_name.to_dict()
        # override the default output from pydantic by calling `to_dict()` of hostname_rewrite_block
        if self.hostname_rewrite_block:
            _dict['hostname_rewrite_block'] = self.hostname_rewrite_block.to_dict()
        ...
        if self.vendor_specific_option_option_space:
            _dict['vendor_specific_option_option_space'] = self.vendor_specific_option_option_space.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asm_config": InheritedASMConfig.from_dict(obj["asm_config"]) if obj.get("asm_config") is not None else None,
            "ddns_client_update": InheritanceInheritedString.from_dict(obj["ddns_client_update"]) if obj.get("ddns_client_update") is not None else None,
            "ddns_conflict_resolution_mode": InheritanceInheritedString.from_dict(obj["ddns_conflict_resolution_mode"]) if obj.get("ddns_conflict_resolution_mode") is not None else None,
            "ddns_enabled": InheritanceInheritedBool.from_dict(obj["ddns_enabled"]) if obj.get("ddns_enabled") is not None else None,
            "ddns_hostname_block": InheritedDDNSHostnameBlock.from_dict(obj["ddns_hostname_block"]) if obj.get("ddns_hostname_block") is not None else None,
            "ddns_ttl_percent": InheritanceInheritedFloat.from_dict(obj["ddns_ttl_percent"]) if obj.get("ddns_ttl_percent") is not None else None,
            "ddns_update_block": InheritedDDNSUpdateBlock.from_dict(obj["ddns_update_block"]) if obj.get("ddns_update_block") is not None else None,
            "ddns_update_on_renew": InheritanceInheritedBool.from_dict(obj["ddns_update_on_renew"]) if obj.get("ddns_update_on_renew") is not None else None,
            "ddns_use_conflict_resolution": InheritanceInheritedBool.from_dict(obj["ddns_use_conflict_resolution"]) if obj.get("ddns_use_conflict_resolution") is not None else None,
            "dhcp_config": InheritedDHCPConfig.from_dict(obj["dhcp_config"]) if obj.get("dhcp_config") is not None else None,
            "dhcp_options": InheritedDHCPOptionList.from_dict(obj["dhcp_options"]) if obj.get("dhcp_options") is not None else None,
            "dhcp_options_v6": InheritedDHCPOptionList.from_dict(obj["dhcp_options_v6"]) if obj.get("dhcp_options_v6") is not None else None,
            "header_option_filename": InheritanceInheritedString.from_dict(obj["header_option_filename"]) if obj.get("header_option_filename") is not None else None,
            "header_option_server_address": InheritanceInheritedString.from_dict(obj["header_option_server_address"]) if obj.get("header_option_server_address") is not None else None,
            "header_option_server_name": InheritanceInheritedString.from_dict(obj["header_option_server_name"]) if obj.get("header_option_server_name") is not None else None,
            "hostname_rewrite_block": InheritedHostnameRewriteBlock.from_dict(obj["hostname_rewrite_block"]) if obj.get("hostname_rewrite_block") is not None else None,
            "vendor_specific_option_option_space": InheritanceInheritedIdentifier.from_dict(obj["vendor_specific_option_option_space"]) if obj.get("vendor_specific_option_option_space") is not None else None
        })
