...
class ServerInheritance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ddns_block", "ddns_client_update", "ddns_conflict_resolution_mode", "ddns_hostname_block", "ddns_ttl_percent", "ddns_update_on_renew", "ddns_use_conflict_resolution", "dhcp_config", "dhcp_options", "dhcp_options_v6", "header_option_filename", "header_option_server_address", "header_option_server_name", "hostname_rewrite_block", "vendor_specific_option_option_space"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ddns_block": InheritedDDNSBlock.from_dict(obj["ddns_block"]) if obj.get("ddns_block") is not None else None,
