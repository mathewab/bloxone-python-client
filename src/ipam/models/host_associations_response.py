...
class HostAssociationsResponse(BaseModel):
    ...
    ha_groups: Optional[List[HAGroup]] = Field(default=None, description="The list of HA groups.")
    host: Optional[Host] = None
    subnets: Optional[List[Subnet]] = Field(default=None, description="The list of subnets.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["dhcp_pkt_stats", "ha_groups", "host", "subnets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dhcp_pkt_stats": DHCPPacketStats.from_dict(obj["dhcp_pkt_stats"]) if obj.get("dhcp_pkt_stats") is not None else None,
            "ha_groups": [HAGroup.from_dict(_item) for _item in obj["ha_groups"]] if obj.get("ha_groups") is not None else None,
