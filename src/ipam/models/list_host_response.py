...
class ListHostResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[Host]] = Field(default=None, description="The list of DHCP Host objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Host.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
