...
class InheritedDHCPOptionItem(BaseModel):
    ...
    overriding_group: Optional[StrictStr] = Field(default=None, description="The resource identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "option": OptionItem.from_dict(obj["option"]) if obj.get("option") is not None else None,
            "overriding_group": obj.get("overriding_group")
        })
