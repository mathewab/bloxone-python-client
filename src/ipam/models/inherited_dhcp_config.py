...
class InheritedDHCPConfig(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.abandoned_reclaim_time:
            _dict['abandoned_reclaim_time'] = self.abandoned_reclaim_time.to_dict()
        ...
        if self.abandoned_reclaim_time_v6:
            _dict['abandoned_reclaim_time_v6'] = self.abandoned_reclaim_time_v6.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "abandoned_reclaim_time": InheritanceInheritedUInt32.from_dict(obj["abandoned_reclaim_time"]) if obj.get("abandoned_reclaim_time") is not None else None,
            "abandoned_reclaim_time_v6": InheritanceInheritedUInt32.from_dict(obj["abandoned_reclaim_time_v6"]) if obj.get("abandoned_reclaim_time_v6") is not None else None,
            "allow_unknown": InheritanceInheritedBool.from_dict(obj["allow_unknown"]) if obj.get("allow_unknown") is not None else None,
            "allow_unknown_v6": InheritanceInheritedBool.from_dict(obj["allow_unknown_v6"]) if obj.get("allow_unknown_v6") is not None else None,
            "echo_client_id": InheritanceInheritedBool.from_dict(obj["echo_client_id"]) if obj.get("echo_client_id") is not None else None,
            "filters": InheritedDHCPConfigFilterList.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "filters_v6": InheritedDHCPConfigFilterList.from_dict(obj["filters_v6"]) if obj.get("filters_v6") is not None else None,
            "ignore_client_uid": InheritanceInheritedBool.from_dict(obj["ignore_client_uid"]) if obj.get("ignore_client_uid") is not None else None,
            "ignore_list": InheritedDHCPConfigIgnoreItemList.from_dict(obj["ignore_list"]) if obj.get("ignore_list") is not None else None,
            "lease_time": InheritanceInheritedUInt32.from_dict(obj["lease_time"]) if obj.get("lease_time") is not None else None,
            "lease_time_v6": InheritanceInheritedUInt32.from_dict(obj["lease_time_v6"]) if obj.get("lease_time_v6") is not None else None
        })
