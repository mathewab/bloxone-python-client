...
class InheritedASMConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asm_enable_block", "asm_growth_block", "asm_threshold", "forecast_period", "history", "min_total", "min_unused"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asm_enable_block": InheritedAsmEnableBlock.from_dict(obj["asm_enable_block"]) if obj.get("asm_enable_block") is not None else None,
            "asm_growth_block": InheritedAsmGrowthBlock.from_dict(obj["asm_growth_block"]) if obj.get("asm_growth_block") is not None else None,
            "asm_threshold": InheritanceInheritedUInt32.from_dict(obj["asm_threshold"]) if obj.get("asm_threshold") is not None else None,
            "forecast_period": InheritanceInheritedUInt32.from_dict(obj["forecast_period"]) if obj.get("forecast_period") is not None else None,
            "history": InheritanceInheritedUInt32.from_dict(obj["history"]) if obj.get("history") is not None else None,
            "min_total": InheritanceInheritedUInt32.from_dict(obj["min_total"]) if obj.get("min_total") is not None else None,
            "min_unused": InheritanceInheritedUInt32.from_dict(obj["min_unused"]) if obj.get("min_unused") is not None else None
        })
