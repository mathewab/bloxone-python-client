...
class DHCPInheritance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asm_config", "ddns_client_update", "ddns_conflict_resolution_mode", "ddns_enabled", "ddns_hostname_block", "ddns_ttl_percent", "ddns_update_block", "ddns_update_on_renew", "ddns_use_conflict_resolution", "dhcp_config", "dhcp_options", "header_option_filename", "header_option_server_address", "header_option_server_name", "hostname_rewrite_block"]
