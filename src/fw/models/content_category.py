...
class ContentCategory(BaseModel):
    ...
    """ # noqa: E501
    category_code: Optional[StrictInt] = Field(default=None, description="The category code.")
    category_name: Optional[StrictStr] = Field(default=None, description="The name of the category.")
    functional_group: Optional[StrictStr] = Field(default=None, description="The functional group name of the category.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["category_code", "category_name", "functional_group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "functional_group": obj.get("functional_group")
        })
