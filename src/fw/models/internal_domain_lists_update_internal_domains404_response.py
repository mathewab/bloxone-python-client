...
class InternalDomainListsUpdateInternalDomains404Response(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[InternalDomainListsUpdateInternalDomains404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": InternalDomainListsUpdateInternalDomains404ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
