...
class InternalDomainListsInternalDomainsItemsPartialUpdate400Response(BaseModel):
    """
    InternalDomainListsInternalDomainsItemsPartialUpdate400Response
    """ # noqa: E501
    error: Optional[InternalDomainListsInternalDomainsItemsPartialUpdate400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": InternalDomainListsInternalDomainsItemsPartialUpdate400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
