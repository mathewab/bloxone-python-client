...
class InternalDomainListsDeleteInternalDomains404Response(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[InternalDomainListsDeleteInternalDomains404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": InternalDomainListsDeleteInternalDomains404ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
