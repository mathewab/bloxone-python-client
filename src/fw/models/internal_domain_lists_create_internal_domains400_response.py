...
class InternalDomainListsCreateInternalDomains400Response(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[InternalDomainListsCreateInternalDomains400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": InternalDomainListsCreateInternalDomains400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
