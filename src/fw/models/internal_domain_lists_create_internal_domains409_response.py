...
class InternalDomainListsCreateInternalDomains409Response(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[InternalDomainListsCreateInternalDomains409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": InternalDomainListsCreateInternalDomains409ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
