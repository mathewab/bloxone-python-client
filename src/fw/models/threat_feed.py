...
class ThreatFeed(BaseModel):
    ...
    """ # noqa: E501
    confidence_level: Optional[StrictStr] = Field(default=None, description="The Confidence Level of the Feed.")
    description: Optional[StrictStr] = Field(default=None, description="The brief description for the thread feed.")
    key: Optional[StrictStr] = Field(default=None, description="The TSIG key of the threat feed.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the thread feed.")
    source: Optional[ThreatFeedSource] = None
    threat_level: Optional[StrictStr] = Field(default=None, description="The Threat Level of the Feed.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["confidence_level", "description", "key", "name", "source", "threat_level"]
