...
class AccessCodesApi:
    ...
    def CreateAccessCode(
        self,
        body: Annotated[AccessCode, Field(description="The Bypass Code object.")],
        ...
        _param = self._CreateAccessCode_serialize(
            body=body,
    ...
    def DeleteAccessCodes(
        ...
        _param = self._DeleteAccessCodes_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def DeleteSingleAccessCodes(
        self,
        access_key: Annotated[StrictStr, Field(description="The Bypass Code identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _DeleteSingleAccessCodes_serialize(
        ...
        if access_key is not None:
            _path_params['access_key'] = self.api_client.path_param_value('access_key', access_key)
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    def ListAccessCodes(
        ...
        _param = self._ListAccessCodes_serialize(
            filter=filter,
            offset=offset,
            limit=limit,
    ...
    def ReadAccessCode(
        self,
        access_key: Annotated[StrictStr, Field(description="The Bypass Code identifier.")],
        name: Annotated[Optional[StrictStr], Field(description="The Bypass Code name.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ReadAccessCode_serialize(
            access_key=access_key,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def UpdateAccessCode(
        self,
        payload_access_key: Annotated[StrictStr, Field(description="Auto generated unique Bypass Code value")],
        body: Annotated[AccessCode, Field(description="The Bypass Code object.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _UpdateAccessCode_serialize(
        ...
        if payload_access_key is not None:
            _path_params['payload.access_key'] = self.api_client.path_param_value('payload.access_key', payload_access_key)
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
