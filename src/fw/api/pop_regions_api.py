...
class PopRegionsApi:
    ...
    def ListPoPRegions(
        ...
        _param = self._ListPoPRegions_serialize(
            filter=filter,
            fields=fields,
            offset=offset,
            limit=limit,
    ...
    def ReadPoPRegion(
        self,
        id: Annotated[StrictInt, Field(description="The PoP region object identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ReadPoPRegion_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
