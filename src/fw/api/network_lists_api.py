...
class NetworkListsApi:
    ...
    def CreateNetworkList(
        self,
        body: Annotated[NetworkList, Field(description="The Network List object.")],
        ...
        _param = self._CreateNetworkList_serialize(
            body=body,
    ...
    def DeleteSingleNetworkLists(
        self,
        id: Annotated[StrictInt, Field(description="The Network List object identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def ListNetworkLists(
        ...
        _param = self._ListNetworkLists_serialize(
            filter=filter,
            fields=fields,
            offset=offset,
            limit=limit,
    ...
    def ReadNetworkList(
        ...
        id: Annotated[StrictInt, Field(description="The Network List object identifier.")],
        fields: Annotated[Optional[StrictStr], Field(description="  A collection of response resources can be transformed by specifying a set of JSON tags to be returned. For a “flat” resource, the tag name is straightforward. If field selection is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, the tag does not appear in the output resource.  Specify this parameter as a comma-separated list of JSON tag names.        ")] = None,
        name: Annotated[Optional[StrictStr], Field(description="The name of the network list.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ReadNetworkList_serialize(
            id=id,
            fields=fields,
            name=name,
            _request_auth=_request_auth,
    ...
    def UpdateNetworkList(
        ...
        _param = self._UpdateNetworkList_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
