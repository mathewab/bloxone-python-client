...
class NamedListItemsApi:
    ...
    def InsertOrReplaceNamedListItems(
        self,
        id: Annotated[StrictInt, Field(description="The Named List object identifier.")],
        body: Annotated[NamedListItemsInsertOrUpdate, Field(description="NamedListItemsInsertOrUpdate object")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def NamedListItemsPartialUpdate(
        self,
        id: Annotated[StrictInt, Field(description="The Named List object identifier.")],
        body: Annotated[NamedListItemsPartialUpdate, Field(description="NamedListItemsPartialUpdate object")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
