...
class CategoryFiltersApi:
    ...
    def CreateCategoryFilter(
        self,
        body: Annotated[CategoryFilter, Field(description="The Category Filter object.")],
    ...
    def DeleteSingleCategoryFilters(
        self,
        id: Annotated[StrictInt, Field(description="The Category Filter object identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
