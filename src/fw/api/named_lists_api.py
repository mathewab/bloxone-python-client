...
class NamedListsApi:
    ...
    def CreateNamedList(
        self,
        body: Annotated[NamedList, Field(description="The Named List object.")],
        ...
        _param = self._CreateNamedList_serialize(
            body=body,
    ...
    def DeleteNamedLists(
        ...
        _param = self._DeleteNamedLists_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def DeleteSingleNamedLists(
        self,
        id: Annotated[StrictInt, Field(description="The Named List object identifiers.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': None,
            '400': "ApplicationFiltersDeleteSingleApplicationFilters400Response",
    ...
    def ListNamedLists(
        ...
        tfilter: Annotated[Optional[StrictStr], Field(description="Filtering by tags.")] = None,
        torder_by: Annotated[Optional[StrictStr], Field(description="Sorting by tags.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ListNamedLists_serialize(
            filter=filter,
            fields=fields,
            offset=offset,
            limit=limit,
    ...
    def ListNamedListsCSV(
        ...
        _param = self._ListNamedListsCSV_serialize(
            filter=filter,
            order_by=order_by,
            tfilter=tfilter,
            torder_by=torder_by,
    ...
    def MultiListUpdate(
        ...
        _param = self._MultiListUpdate_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "object",
            '400': "InternalDomainListsInternalDomainsItemsPartialUpdate400Response",
    ...
    def ReadNamedList(
        self,
        id: Annotated[StrictInt, Field(description="The Named List identifier.")],
        fields: Annotated[Optional[StrictStr], Field(description="  A collection of response resources can be transformed by specifying a set of JSON tags to be returned. For a “flat” resource, the tag name is straightforward. If field selection is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, the tag does not appear in the output resource.  Specify this parameter as a comma-separated list of JSON tag names.        ")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="  The integer index (zero-origin) of the offset into a collection of resources. If omitted or null the value is assumed to be '0'.         ")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="  The integer number of resources to be returned in the response. The service may impose maximum value. If omitted the service may impose a default value.         ")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="  The service-defined string used to identify a page of resources. A null value indicates the first page.         ")] = None,
        name: Annotated[Optional[StrictStr], Field(description="The name of the named list. Can be used in pair with 'type' (both fields are mandatory) to request the object by their name. This aproach available only if the field 'id' is empty (==0).")] = None,
        type: Annotated[Optional[StrictStr], Field(description="The type of the named list. See 'NamedList' for more details.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._ReadNamedList_serialize(
            id=id,
            fields=fields,
            offset=offset,
            limit=limit,
    ...
    def UpdateNamedList(
        self,
        id: Annotated[StrictInt, Field(description="The Named List object identifier.")],
        body: Annotated[NamedList, Field(description="The Named List object.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._UpdateNamedList_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def UpdateNamedListPartial(
        self,
        id: Annotated[StrictInt, Field(description="The Named List object identifier.")],
        body: Annotated[ListSeverityLevels, Field(description="The Named List object.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
