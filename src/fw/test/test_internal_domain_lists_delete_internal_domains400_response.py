...
class TestInternalDomainListsDeleteInternalDomains400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InternalDomainListsDeleteInternalDomains400Response:
