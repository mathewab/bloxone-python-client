...
class OspfConfig(BaseModel):
    ...
    OspfConfig
    """ # noqa: E501
    area: Optional[StrictStr] = Field(default=None, description="OSPF area identifier; usually in the format of an IPv4 address (although not an address itself)")
    ...
    interface: Optional[StrictStr] = Field(default=None, description="Name of the interface that is configured with external IP address of the host")
    preamble: Optional[StrictStr] = Field(default=None, description="Any predefined OSPF configuration, with embedded new lines; the preamble will be prepended to the generated BGP configuration.")
    retransmit_interval: Optional[StrictInt] = None
    transmit_delay: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["area", "area_type", "authentication_key", "authentication_key_id", "authentication_type", "cost", "dead_interval", "hello_interval", "interface", "preamble", "retransmit_interval", "transmit_delay"]
