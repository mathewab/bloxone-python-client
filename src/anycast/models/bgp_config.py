...
class BgpConfig(BaseModel):
    ...
    asn_text: Optional[StrictStr] = Field(default=None, description="Examples:     ASDOT        ASPLAIN     INTEGER     VALID/INVALID     0.1          1           1           Valid     1            1           1           Valid     65535        65535       65535       Valid     0.65535      65535       65535       Valid     1.0          65536       65536       Valid     1.1          65537       65537       Valid     1.65535      131071      131071      Valid     65535.0      4294901760  4294901760  Valid     65535.1      4294901761  4294901761  Valid     65535.65535  4294967295  4294967295  Valid      0.65536                              Invalid     65535.655536                         Invalid     65536.0                              Invalid     65536.65535                          Invalid                  4294967296              Invalid")
    fields: Optional[BufFieldMask] = None
    ...
    preamble: Optional[StrictStr] = Field(default=None, description="Any predefined BGP configuration, with embedded new lines; the preamble will be prepended to the generated BGP configuration.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asn", "asn_text", "fields", "holddown_secs", "keep_alive_secs", "link_detect", "neighbors", "preamble"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": BufFieldMask.from_dict(obj["fields"]) if obj.get("fields") is not None else None,
            "holddown_secs": obj.get("holddown_secs"),
            "keep_alive_secs": obj.get("keep_alive_secs"),
            "link_detect": obj.get("link_detect"),
            "neighbors": [BgpNeighbor.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None,
