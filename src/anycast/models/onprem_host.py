...
class OnpremHost(BaseModel):
    ...
    ip_address: Optional[StrictStr] = Field(default=None, description="IPv4 address of the on-prem host")
    ipv6_address: Optional[StrictStr] = Field(default=None, description="IPv6 address of the on-prem host")
    name: Optional[StrictStr] = None
    updated_at: Optional[datetime] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["anycast_config_refs", "config_bgp", "config_ospf", "config_ospfv3", "created_at", "id", "ip_address", "ipv6_address", "name", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anycast_config_refs": [AnycastConfigRef.from_dict(_item) for _item in obj["anycast_config_refs"]] if obj.get("anycast_config_refs") is not None else None,
            "config_bgp": BgpConfig.from_dict(obj["config_bgp"]) if obj.get("config_bgp") is not None else None,
            "config_ospf": OspfConfig.from_dict(obj["config_ospf"]) if obj.get("config_ospf") is not None else None,
            "config_ospfv3": Ospfv3Config.from_dict(obj["config_ospfv3"]) if obj.get("config_ospfv3") is not None else None,
