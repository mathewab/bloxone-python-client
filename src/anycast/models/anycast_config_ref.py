...
class AnycastConfigRef(BaseModel):
    ...
    routing_protocols: Optional[List[StrictStr]] = Field(default=None, description="Routing protocols enabled for this anycast configuration, on a particular host. Valid protocol names are \"BGP\", \"OSPF\"/\"OSPFv2\", \"OSPFv3\".")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["anycast_config_name", "routing_protocols"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anycast_config_name": obj.get("anycast_config_name"),
            "routing_protocols": obj.get("routing_protocols")
        })
