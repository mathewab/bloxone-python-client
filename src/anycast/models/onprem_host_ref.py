...
class OnpremHostRef(BaseModel):
    ...
    ip_address: Optional[StrictStr] = Field(default=None, description="IPv4 address of the host in string format")
    ipv6_address: Optional[StrictStr] = Field(default=None, description="IPv6 address of the host in string format")
    name: Optional[StrictStr] = None
    ophid: Optional[StrictStr] = Field(default=None, description="Unique 32-character string identifier assigned to the host")
    runtime_status: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "ip_address", "ipv6_address", "name", "ophid", "runtime_status"]
