...
class AnycastConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account_id", "anycast_ip_address", "anycast_ipv6_address", "created_at", "description", "fields", "id", "is_configured", "name", "onprem_hosts", "runtime_status", "service", "tags", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "anycast_ip_address": obj.get("anycast_ip_address"),
            "anycast_ipv6_address": obj.get("anycast_ipv6_address"),
            ...
            "name": obj.get("name"),
            "onprem_hosts": [OnpremHostRef.from_dict(_item) for _item in obj["onprem_hosts"]] if obj.get("onprem_hosts") is not None else None,
