...
class BgpNeighbor(BaseModel):
    ...
    ip_address: Optional[StrictStr] = Field(default=None, description="IPv4 address of the BGP neighbor")
    max_hop_count: Optional[StrictInt] = None
    multihop: Optional[StrictBool] = None
    password: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asn", "asn_text", "ip_address", "max_hop_count", "multihop", "password"]
