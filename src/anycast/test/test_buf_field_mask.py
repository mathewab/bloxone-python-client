...
from anycast.models.buf_field_mask import bufFieldMask

class TestbufFieldMask(unittest.TestCase):
    """bufFieldMask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> bufFieldMask:
        """Test bufFieldMask
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `bufFieldMask`
        """
        model = bufFieldMask()
        if include_optional:
            return bufFieldMask(
