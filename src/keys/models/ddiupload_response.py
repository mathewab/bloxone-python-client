...
class DdiuploadResponse(BaseModel):
    ...
    warning: Optional[StrictStr] = Field(default=None, description="May contain any non-critical warning messages after processing the content.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kerberos_keys": KerberosKeys.from_dict(obj["kerberos_keys"]) if obj.get("kerberos_keys") is not None else None,
