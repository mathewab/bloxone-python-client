...
class ListKerberosKeyResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[KerberosKey]] = Field(default=None, description="The list of KerberosKey objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [KerberosKey.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
