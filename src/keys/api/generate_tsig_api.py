...
class GenerateTsigApi:
    ...
    def GenerateTSIG(
        self,
        algorithm: Annotated[Optional[StrictStr], Field(description="The TSIG key algorithm.  Valid values are: * _hmac_sha256_ * _hmac_sha1_ * _hmac_sha224_ * _hmac_sha384_ * _hmac_sha512_  Defaults to _hmac_sha256_.")] = None,
        ...
        _param = self._GenerateTSIG_serialize(
            algorithm=algorithm,
