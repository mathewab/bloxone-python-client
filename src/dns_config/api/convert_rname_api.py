...
class ConvertRnameApi:
    ...
    def ConvertRName(
        self,
        email_address: Annotated[StrictStr, Field(description="Input email address.")],
        ...
        _param = self._ConvertRName_serialize(
    ...
    def _ConvertRName_serialize(
        ...
        if email_address is not None:
            _path_params['email_address'] = self.api_client.path_param_value('email_address', email_address)
