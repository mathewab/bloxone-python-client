...
class ConvertDomainNameApi:
    ...
    def Convert(
        self,
        domain_name: Annotated[StrictStr, Field(description="Input domain name in either of IDN or punycode representations.")],
    ...
    def _Convert_serialize(
        ...
        if domain_name is not None:
            _path_params['domain_name'] = self.api_client.path_param_value('domain_name', domain_name)
