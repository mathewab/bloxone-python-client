...
class AuthZoneExternalProvider(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The identifier of the external provider.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the external provider.")
