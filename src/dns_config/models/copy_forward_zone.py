...
class CopyForwardZone(BaseModel):
    ...
    CopyForwardZone
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="A comment of the (copied) _dns/forward_zone_ object.")
    ...
    __properties: ClassVar[List[str]] = ["comment", "external_forwarders", "hosts", "id", "internal_forwarders", "nsgs", "recursive", "skip_on_error", "target_view"]
