...
class InheritedZoneAuthority(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["default_ttl", "expire", "mname_block", "negative_ttl", "protocol_rname", "refresh", "retry", "rname"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "default_ttl": Inheritance2InheritedUInt32.from_dict(obj["default_ttl"]) if obj.get("default_ttl") is not None else None,
            "expire": Inheritance2InheritedUInt32.from_dict(obj["expire"]) if obj.get("expire") is not None else None,
            "mname_block": InheritedZoneAuthorityMNameBlock.from_dict(obj["mname_block"]) if obj.get("mname_block") is not None else None,
            "negative_ttl": Inheritance2InheritedUInt32.from_dict(obj["negative_ttl"]) if obj.get("negative_ttl") is not None else None,
            "protocol_rname": Inheritance2InheritedString.from_dict(obj["protocol_rname"]) if obj.get("protocol_rname") is not None else None,
            "refresh": Inheritance2InheritedUInt32.from_dict(obj["refresh"]) if obj.get("refresh") is not None else None,
            "retry": Inheritance2InheritedUInt32.from_dict(obj["retry"]) if obj.get("retry") is not None else None,
            "rname": Inheritance2InheritedString.from_dict(obj["rname"]) if obj.get("rname") is not None else None
        })
