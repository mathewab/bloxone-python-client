...
class ViewInheritance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["add_edns_option_in_outgoing_query", "custom_root_ns_block", "dnssec_validation_block", "dtc_config", "ecs_block", "edns_udp_size", "filter_aaaa_acl", "filter_aaaa_on_v4", "forwarders_block", "gss_tsig_enabled", "lame_ttl", "match_recursive_only", "max_cache_ttl", "max_negative_ttl", "max_udp_size", "minimal_responses", "notify", "query_acl", "recursion_acl", "recursion_enabled", "sort_list", "synthesize_address_records_from_https", "transfer_acl", "update_acl", "use_forwarders_for_subzones", "zone_authority"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dtc_config": InheritedDtcConfig.from_dict(obj["dtc_config"]) if obj.get("dtc_config") is not None else None,
            "ecs_block": InheritedECSBlock.from_dict(obj["ecs_block"]) if obj.get("ecs_block") is not None else None,
            "edns_udp_size": Inheritance2InheritedUInt32.from_dict(obj["edns_udp_size"]) if obj.get("edns_udp_size") is not None else None,
            ...
            "max_udp_size": Inheritance2InheritedUInt32.from_dict(obj["max_udp_size"]) if obj.get("max_udp_size") is not None else None,
            ...
            "zone_authority": InheritedZoneAuthority.from_dict(obj["zone_authority"]) if obj.get("zone_authority") is not None else None
        })
