...
class ListViewResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[View]] = Field(default=None, description="List of View objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [View.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
