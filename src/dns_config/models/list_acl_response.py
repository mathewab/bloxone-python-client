...
class ListACLResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[ACL]] = Field(default=None, description="List of ACL objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ACL.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
