...
class ServerInheritance(BaseModel):
    ...
    """ # noqa: E501
    add_edns_option_in_outgoing_query: Optional[Inheritance2InheritedBool] = None
    ...
    synthesize_address_records_from_https: Optional[Inheritance2InheritedBool] = None
    ...
    __properties: ClassVar[List[str]] = ["add_edns_option_in_outgoing_query", "custom_root_ns_block", "dnssec_validation_block", "ecs_block", "filter_aaaa_acl", "filter_aaaa_on_v4", "forwarders_block", "gss_tsig_enabled", "kerberos_keys", "lame_ttl", "log_query_response", "match_recursive_only", "max_cache_ttl", "max_negative_ttl", "minimal_responses", "notify", "query_acl", "query_port", "recursion_acl", "recursion_enabled", "recursive_clients", "resolver_query_timeout", "secondary_axfr_query_limit", "secondary_soa_query_limit", "sort_list", "synthesize_address_records_from_https", "transfer_acl", "update_acl", "use_forwarders_for_subzones"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.add_edns_option_in_outgoing_query:
            _dict['add_edns_option_in_outgoing_query'] = self.add_edns_option_in_outgoing_query.to_dict()
        ...
        if self.dnssec_validation_block:
            _dict['dnssec_validation_block'] = self.dnssec_validation_block.to_dict()
        ...
        if self.resolver_query_timeout:
            _dict['resolver_query_timeout'] = self.resolver_query_timeout.to_dict()
        ...
        if self.secondary_axfr_query_limit:
            _dict['secondary_axfr_query_limit'] = self.secondary_axfr_query_limit.to_dict()
        ...
        if self.secondary_soa_query_limit:
            _dict['secondary_soa_query_limit'] = self.secondary_soa_query_limit.to_dict()
        ...
        if self.synthesize_address_records_from_https:
            _dict['synthesize_address_records_from_https'] = self.synthesize_address_records_from_https.to_dict()
        ...
        if self.use_forwarders_for_subzones:
            _dict['use_forwarders_for_subzones'] = self.use_forwarders_for_subzones.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add_edns_option_in_outgoing_query": Inheritance2InheritedBool.from_dict(obj["add_edns_option_in_outgoing_query"]) if obj.get("add_edns_option_in_outgoing_query") is not None else None,
            "custom_root_ns_block": InheritedCustomRootNSBlock.from_dict(obj["custom_root_ns_block"]) if obj.get("custom_root_ns_block") is not None else None,
            "dnssec_validation_block": InheritedDNSSECValidationBlock.from_dict(obj["dnssec_validation_block"]) if obj.get("dnssec_validation_block") is not None else None,
            "ecs_block": InheritedECSBlock.from_dict(obj["ecs_block"]) if obj.get("ecs_block") is not None else None,
            "filter_aaaa_acl": InheritedACLItems.from_dict(obj["filter_aaaa_acl"]) if obj.get("filter_aaaa_acl") is not None else None,
            "filter_aaaa_on_v4": Inheritance2InheritedString.from_dict(obj["filter_aaaa_on_v4"]) if obj.get("filter_aaaa_on_v4") is not None else None,
            "forwarders_block": InheritedForwardersBlock.from_dict(obj["forwarders_block"]) if obj.get("forwarders_block") is not None else None,
            "gss_tsig_enabled": Inheritance2InheritedBool.from_dict(obj["gss_tsig_enabled"]) if obj.get("gss_tsig_enabled") is not None else None,
            "kerberos_keys": InheritedKerberosKeys.from_dict(obj["kerberos_keys"]) if obj.get("kerberos_keys") is not None else None,
            "lame_ttl": Inheritance2InheritedUInt32.from_dict(obj["lame_ttl"]) if obj.get("lame_ttl") is not None else None,
            "log_query_response": Inheritance2InheritedBool.from_dict(obj["log_query_response"]) if obj.get("log_query_response") is not None else None,
            "match_recursive_only": Inheritance2InheritedBool.from_dict(obj["match_recursive_only"]) if obj.get("match_recursive_only") is not None else None,
            "max_cache_ttl": Inheritance2InheritedUInt32.from_dict(obj["max_cache_ttl"]) if obj.get("max_cache_ttl") is not None else None,
            "max_negative_ttl": Inheritance2InheritedUInt32.from_dict(obj["max_negative_ttl"]) if obj.get("max_negative_ttl") is not None else None,
            "minimal_responses": Inheritance2InheritedBool.from_dict(obj["minimal_responses"]) if obj.get("minimal_responses") is not None else None,
            "notify": Inheritance2InheritedBool.from_dict(obj["notify"]) if obj.get("notify") is not None else None,
            "query_acl": InheritedACLItems.from_dict(obj["query_acl"]) if obj.get("query_acl") is not None else None,
            "query_port": Inheritance2InheritedUInt32.from_dict(obj["query_port"]) if obj.get("query_port") is not None else None,
            "recursion_acl": InheritedACLItems.from_dict(obj["recursion_acl"]) if obj.get("recursion_acl") is not None else None,
            "recursion_enabled": Inheritance2InheritedBool.from_dict(obj["recursion_enabled"]) if obj.get("recursion_enabled") is not None else None,
            "recursive_clients": Inheritance2InheritedUInt32.from_dict(obj["recursive_clients"]) if obj.get("recursive_clients") is not None else None,
            "resolver_query_timeout": Inheritance2InheritedUInt32.from_dict(obj["resolver_query_timeout"]) if obj.get("resolver_query_timeout") is not None else None,
            "secondary_axfr_query_limit": Inheritance2InheritedUInt32.from_dict(obj["secondary_axfr_query_limit"]) if obj.get("secondary_axfr_query_limit") is not None else None,
            "secondary_soa_query_limit": Inheritance2InheritedUInt32.from_dict(obj["secondary_soa_query_limit"]) if obj.get("secondary_soa_query_limit") is not None else None,
            "sort_list": InheritedSortListItems.from_dict(obj["sort_list"]) if obj.get("sort_list") is not None else None,
            "synthesize_address_records_from_https": Inheritance2InheritedBool.from_dict(obj["synthesize_address_records_from_https"]) if obj.get("synthesize_address_records_from_https") is not None else None,
            "transfer_acl": InheritedACLItems.from_dict(obj["transfer_acl"]) if obj.get("transfer_acl") is not None else None,
            "update_acl": InheritedACLItems.from_dict(obj["update_acl"]) if obj.get("update_acl") is not None else None,
            "use_forwarders_for_subzones": Inheritance2InheritedBool.from_dict(obj["use_forwarders_for_subzones"]) if obj.get("use_forwarders_for_subzones") is not None else None
        })
