...
class TestApiClient(unittest.TestCase):
    ...
    def test_default_client(self):
        ...
        self.assertEqual(self.api_client.configuration.csp_url, 'https://csp.infoblox.com')
        self.assertEqual(self.api_client.configuration.client_name, 'bloxone-python-client')

    def test_path_param_value_with_resource_id_type(self):
        result = self.api_client.path_param_value('id', 'app/type/id', 'resource_id')
    ...
    def test_path_param_value_with_non_id_key_and_resource_id_type(self):
        result = self.api_client.path_param_value('key', 'type/id', 'resource_id')
        self.assertEqual(result, 'id')
