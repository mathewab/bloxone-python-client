...
from bloxone_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
        ...
        try:
            if response_type == "bytearray":
                ...
                if response_type in ["bytearray", "str"]:
                    ...
                    return_data = self.deserialize(models, response_text, response_type)
        finally:
    ...
    def __deserialize(self, models, data, klass):
        ...
        if isinstance(klass, str):
            if klass.startswith('List['):
                ...
                sub_kls = m.group(1)
                return [self.__deserialize(models, sub_data, sub_kls)
            ...
            if klass.startswith('Dict['):
                ...
                sub_kls = m.group(2)
                return {k: self.__deserialize(models, v, sub_kls)
    ...
    def update_params_for_auth(
        ...
        """
        headers['Authorization'] = "Token {}".format(self.configuration.api_key)
